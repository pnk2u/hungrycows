...
public abstract class LivingEntityRendererMixin<T extends LivingEntity, S extends LivingEntityRenderState, M extends EntityModel<? super S>> {
    ...
    private Identifier wrappedGetRenderTypeAtGetTextureLocation(LivingEntityRenderer<T, S, M> instance, S livingEntityRenderState, Operation<Identifier> original) {
        Identifier originalTexture = original.call(instance, livingEntityRenderState);
