<!--publish=false-->
### 2.2.0:
- Implement _Mooshrooms_ and _Cows_ eating plant blocks (e.g. _Short Grass_) like _Sheep_. This is controlled by tags, that by default contain the following items:
  ...
  - `#minecraft:small_flowers`   
    > (For _Brown Mooshrooms_, their _Stew_ becomes _Suspicious_ like when being fed the same flowers.)
...
- Change _Mooshroom_ eating logic to not eat Mycelium that has a _Mushroom_ on top of it
...
- Implement eating sound for _Cows_ and _Sheep_ eating _Grass Blocks_
